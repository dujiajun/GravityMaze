...
void ILI9341_Draw_Rec_Color(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint8_t r, uint8_t g, uint8_t b)
{
	ILI9341_OpenWindow(x, y, w, h);
	ILI9341_FillColor(w*h,RGB888_2_RGB565(r, g, b));
}

void ILI9341_Clear_Window()
{
	ILI9341_Draw_Rec_Color(0, 0, 240, 320, 0, 0, 0);
}
/*********************end of file*************************/
